...
export const DESTINATIONS: DestinationCard[] = [
  ...
  },
  {
    ...
    color: "var(--sage)",
    img: IMG.tuscanyHero,
    headline: "A villa in Chianti, the harvest week, one Florence day.",
    price: "$$$$",
  },
  {
    no: 17,
    ...
    color: "var(--peach)",
    img: IMG.sevillaHero,
    headline: "Long lunches, late flamenco, a day-trip for sherry.",
    price: "$$",
  },
  {
    no: 18,
    ...
    headline: "Pines, oysters at the dock, the quiet French coast.",
    price: "$$$",
  },
];
